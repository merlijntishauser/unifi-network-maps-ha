...
function createDOMPurify() {
  ...
  const _readNodeType = function _readNodeType2(node) {
    return getNodeType3 ? getNodeType3(node) : node.nodeType;
  };
...
function renderVpnTunnelsSection(context, name, helpers) {
  ...
  const tunnelRows = tunnels.map((t) => {
    ...
    const statusLabel = t.up ? helpers.localize("panel.vpn.status_up") : helpers.localize("panel.vpn.status_down");
    ...
    const ifnameRow = t.ifname ? `<div class="stats-row"><span class="stats-row__label">${helpers.localize("panel.vpn.interface")}</span><span class="stats-row__value"><code>${helpers.escapeHtml(t.ifname)}</code></span></div>` : "";
    const subnetsRow = subnets ? `<div class="stats-row"><span class="stats-row__label">${helpers.localize("panel.vpn.remote_subnets")}</span><span class="stats-row__value">${subnets}</span></div>` : "";
    return `
...
var da = {
  ...
  "card.error.load_payload": "Kunne ikke indl\xE6se data ({error})",
  "card.error.load_svg": "Kunne ikke indl\xE6se SVG ({error})",
  "card.error.missing_auth": "Manglende godkendelsestoken",
  "card.error.missing_config": "Manglende konfiguration",
  "card.error.missing_entry": "V\xE6lg en UniFi Network Map-instans i kortindstillingerne.",
  "card.error.retry": "Pr\xF8v igen",
  "card.error.unknown": "Ukendt fejl",
  "card.filter.hide": "Skjul {label}",
  "card.filter.show": "Vis {label}",
  "card.loading.aria": "Indl\xE6ser",
  "card.loading.map": "Indl\xE6ser kort...",
  "card.loading.refresh": "Opdaterer data...",
  "card.preview.alt": "UniFi Network Map forh\xE5ndsvisning",
  ...
  "editor.theme.unifi_dark": "UniFi M\xF8rk",
  "editor.svg_theme": "Kortfarver",
  "editor.svg_theme.unifi": "UniFi (standard)",
  "editor.svg_theme.unifi_dark": "UniFi M\xF8rk",
  "editor.svg_theme.minimal": "Minimal",
  "editor.svg_theme.minimal_dark": "Minimal M\xF8rk",
  "editor.svg_theme.classic": "Klassisk",
  "editor.svg_theme.classic_dark": "Klassisk M\xF8rk",
  ...
  "panel.hint": "Klik p\xE5 en node i kortet for at se detaljer",
  "panel.loading": "Indl\xE6ser netv\xE6rksdata...",
  "panel.network": "Netv\xE6rk",
  "panel.network_info": "Netv\xE6rksoplysninger",
  "panel.no_connections": "Ingen forbindelser",
  "panel.no_data": "Ingen data tilg\xE6ngelig",
  "panel.overview": "Netv\xE6rksoversigt",
  ...
  "panel.stats.wireless": "Tr\xE5dl\xF8s",
  "panel.stats.wireless_clients": "Tr\xE5dl\xF8se klienter",
  "panel.status.last_changed": "Sidst \xE6ndret",
...
// src/card/shared/locales/fi.ts
var fi = {
  "card.controls.reset": "Nollaa",
  "card.controls.reset_view": "Nollaa n\xE4kym\xE4",
  "card.controls.zoom_in": "L\xE4henn\xE4",
  "card.controls.zoom_out": "Loitonna",
  "card.error.load_payload": "Kuorman lataus ep\xE4onnistui ({error})",
  "card.error.load_svg": "SVG:n lataus ep\xE4onnistui ({error})",
  "card.error.missing_auth": "Todennustunnus puuttuu",
  "card.error.missing_config": "M\xE4\xE4ritykset puuttuvat",
  "card.error.missing_entry": "Valitse UniFi-verkkokarttainstanssi kortin asetuksista.",
  "card.error.retry": "Yrit\xE4 uudelleen",
  "card.error.unknown": "Tuntematon virhe",
  "card.filter.hide": "Piilota {label}",
  "card.filter.show": "N\xE4yt\xE4 {label}",
  "card.loading.aria": "Ladataan",
  "card.loading.map": "Ladataan karttaa...",
  "card.loading.refresh": "P\xE4ivitet\xE4\xE4n tietoja...",
  ...
  "context_menu.restart": "K\xE4ynnist\xE4 laite uudelleen",
  "context_menu.view_details": "N\xE4yt\xE4 tiedot",
  ...
  "editor.svg_theme": "Kartan v\xE4rit",
  ...
  "edge_tooltip.poe": "PoE-sy\xF6tetty",
  "edge_tooltip.speed_gbps": "{speed} Gbps",
  "edge_tooltip.speed_mbps": "{speed} Mbps",
  ...
  "entity_modal.no_entities": "T\xE4lle laitteelle ei l\xF6ytynyt Home Assistant -entiteettej\xE4",
  "entity_modal.related_entities": "Liittyv\xE4t entiteetit",
  "entity_modal.related_entities_count": "Liittyv\xE4t entiteetit ({count})",
  ...
  "panel.actions.no_entity": "Ei linkitetty\xE4 Home Assistant -entiteetti\xE4",
  "panel.actions.title": "Pikatoiminnot",
  "panel.actions.view_entity": "N\xE4yt\xE4 entiteetin tiedot",
  "panel.actions.view_ports": "N\xE4yt\xE4 porttikatsaus",
  "panel.badge.poe": "PoE",
  "panel.badge.wifi": "WiFi",
  ...
  "toast.no_entity": "T\xE4lle laitteelle ei l\xF6ytynyt entiteetti\xE4",
  "toast.restart_sent": "Uudelleenk\xE4ynnistyskomento l\xE4hetetty"
};
...
// src/card/shared/locales/is.ts
var is = {
  "card.controls.reset": "Endurstilla",
  "card.controls.reset_view": "Endurstilla s\xFDn",
  "card.controls.zoom_in": "\xDEysja inn",
  "card.controls.zoom_out": "\xDEysja \xFAt",
  "card.error.load_payload": "Ekki t\xF3kst a\xF0 hla\xF0a g\xF6gnum ({error})",
  "card.error.load_svg": "Ekki t\xF3kst a\xF0 hla\xF0a SVG ({error})",
  "card.error.missing_auth": "Au\xF0kenningarlykil vantar",
  "card.error.missing_config": "Stillingar vantar",
  "card.error.missing_entry": "Veldu UniFi Network Map tilvik \xED spjaldstillingunum.",
  "card.error.retry": "Reyna aftur",
  "card.error.unknown": "\xD3\xFEekkt villa",
  "card.filter.hide": "Fela {label}",
  "card.filter.show": "S\xFDna {label}",
  "card.loading.aria": "Hle\xF0ur",
  "card.loading.map": "Hle\xF0ur kort...",
  "card.loading.refresh": "Uppf\xE6ri g\xF6gn...",
  "card.preview.alt": "UniFi Network Map forsko\xF0un",
  "card.time.days_ago": "{count}d s\xED\xF0an",
  "card.time.hours_ago": "{count}klst s\xED\xF0an",
  "card.time.just_now": "R\xE9tt \xED \xFEessu",
  "card.time.minutes_ago": "{count}m\xEDn s\xED\xF0an",
  "card.time.unknown": "\xD3\xFEekkt",
  "context_menu.copy_ip": "Afrita IP-t\xF6lu",
  "context_menu.copy_mac": "Afrita MAC-vistfang",
  "context_menu.restart": "Endurr\xE6sa t\xE6ki",
  "context_menu.view_details": "Sko\xF0a n\xE1nar",
  ...
  "editor.theme.light": "Lj\xF3st",
  "editor.theme.unifi": "UniFi (sj\xE1lfgefi\xF0)",
  "editor.theme.unifi_dark": "UniFi D\xF6kkt",
  "editor.svg_theme": "Kortalitiur",
  "editor.svg_theme.unifi": "UniFi (sj\xE1lfgefi\xF0)",
  "editor.svg_theme.unifi_dark": "UniFi D\xF6kkt",
  "editor.svg_theme.minimal": "Einfalt",
  "editor.svg_theme.minimal_dark": "Einfalt D\xF6kkt",
  "editor.svg_theme.classic": "Klass\xEDskt",
  "editor.svg_theme.classic_dark": "Klass\xEDskt D\xF6kkt",
  "editor.icon_set": "T\xE1knmyndast\xEDll",
  "editor.icon_set.modern": "N\xFAt\xEDmalegt (sj\xE1lfgefi\xF0)",
  "editor.icon_set.isometric": "\xCDs\xF3metr\xEDsk",
  "edge_tooltip.band_24": "2.4GHz",
  "edge_tooltip.band_5": "5GHz",
  "edge_tooltip.band_6": "6GHz",
  "edge_tooltip.channel": "R\xE1s {channel}{suffix}",
  "edge_tooltip.poe": "PoE-kn\xFAi\xF0",
  "edge_tooltip.speed_gbps": "{speed} Gbps",
  "edge_tooltip.speed_mbps": "{speed} Mbps",
  "edge_tooltip.wired": "Sn\xFArutengt",
  "edge_tooltip.wireless": "\xDEr\xE1\xF0laust",
  "entity_modal.device_info": "T\xE6kjauppl\xFDsingar",
  "entity_modal.device_type": "T\xE6kjager\xF0",
  "entity_modal.ip": "IP-tala",
  "entity_modal.last_changed": "S\xED\xF0ast breytt",
  "entity_modal.mac": "MAC-vistfang",
  "entity_modal.model": "Ger\xF0",
  "entity_modal.no_entities": "Engar Home Assistant einingar fundust fyrir \xFEetta t\xE6ki",
  "entity_modal.related_entities": "Tengdar einingar",
  "entity_modal.related_entities_count": "Tengdar einingar ({count})",
  "entity_modal.status": "Sta\xF0a",
  "entity_modal.status_offline": "\xD3tengt",
  "entity_modal.status_online": "Tengt",
  "entity_modal.status_unknown": "\xD3\xFEekkt",
  "panel.actions.copy_ip": "Afrita IP-t\xF6lu",
  ...
  "panel.actions.title": "Fl\xFDtia\xF0ger\xF0ir",
  "panel.actions.view_entity": "Sko\xF0a einingu n\xE1nar",
  "panel.actions.view_ports": "Sko\xF0a g\xE1ttayfirlit",
  "panel.badge.poe": "PoE",
  "panel.badge.wifi": "WiFi",
  "panel.connected_devices": "Tengd t\xE6ki",
  "panel.device_breakdown": "T\xE6kjasundurli\xF0un",
  "panel.device_info": "T\xE6kjauppl\xFDsingar",
  "panel.device_type.access_points": "A\xF0gangssta\xF0ir",
  "panel.device_type.clients": "Bi\xF0larar",
  "panel.device_type.gateways": "G\xE1ttir",
  "panel.device_type.other": "Anna\xF0",
  "panel.device_type.switches": "Rofar",
  "panel.entities": "Home Assistant einingar",
  "panel.hint": "Smelltu \xE1 hn\xFAt \xE1 kortinu til a\xF0 sj\xE1 n\xE1nar",
  "panel.loading": "Hle\xF0 netg\xF6gnum...",
  "panel.network": "Netkerfi",
  "panel.network_info": "Netkerfisuppl\xFDsingar",
  "panel.no_connections": "Engar tengingar",
  "panel.no_data": "Engin g\xF6gn tilt\xE6k",
  "panel.overview": "Netkerfisyfirlit",
  "panel.overview.connections": "Tengingar",
  "panel.overview.total_nodes": "Heildarfj\xF6ldi hn\xFAta",
  "panel.stats.connection": "Tengingat\xF6lfr\xE6\xF0i",
  "panel.stats.connection_poe": "PoE-kn\xFAi\xF0",
  "panel.stats.ip": "IP-tala",
  "panel.stats.mac": "MAC-vistfang",
  "panel.stats.model": "Ger\xF0",
  "panel.stats.total_connections": "Heildarfj\xF6ldi tenginga",
  "panel.stats.wired": "Sn\xFArutengt",
  "panel.stats.wireless": "\xDEr\xE1\xF0laust",
  "panel.stats.wireless_clients": "\xDEr\xE1\xF0lausir bi\xF0larar",
  "panel.status.last_changed": "S\xED\xF0ast breytt",
  "panel.status.live": "Raunt\xEDmasta\xF0a",
  "panel.status.offline": "\xD3tengt",
  "panel.status.online": "Tengt",
  "panel.status.status": "Sta\xF0a",
  "panel.status.unknown": "\xD3\xFEekkt",
  "panel.tabs.actions": "A\xF0ger\xF0ir",
  ...
  "port_modal.title": "G\xE1ttayfirlit",
  "toast.copied": "Afrita\xF0!",
  "toast.copy_ip": "IP-tala afritu\xF0!",
  "toast.copy_mac": "MAC-vistfang afrita\xF0!",
  "toast.no_entity": "Engin eining fannst fyrir \xFEetta t\xE6ki",
  "toast.restart_sent": "Endurr\xE6singarskipun send"
};

// src/card/shared/locales/nb.ts
var nb = {
...
// src/card/shared/locales/sv.ts
var sv = {
  "card.controls.reset": "\xC5terst\xE4ll",
  "card.controls.reset_view": "\xC5terst\xE4ll vy",
  ...
  "card.error.missing_entry": "V\xE4lj en UniFi Network Map-instans i kortinst\xE4llningarna.",
  "card.error.retry": "F\xF6rs\xF6k igen",
  "card.error.unknown": "Ok\xE4nt fel",
  "card.filter.hide": "D\xF6lj {label}",
  "card.filter.show": "Visa {label}",
  "card.loading.aria": "Laddar",
  "card.loading.map": "Laddar karta...",
  "card.loading.refresh": "Uppdaterar data...",
  "card.preview.alt": "F\xF6rhandsgranskning av UniFi Network Map",
  ...
  "editor.theme.unifi": "UniFi (standard)",
  "editor.theme.unifi_dark": "UniFi M\xF6rkt",
  "editor.svg_theme": "Kartf\xE4rger",
  "editor.svg_theme.unifi": "UniFi (standard)",
  "editor.svg_theme.unifi_dark": "UniFi M\xF6rkt",
  "editor.svg_theme.minimal": "Minimal",
  "editor.svg_theme.minimal_dark": "Minimal M\xF6rkt",
  "editor.svg_theme.classic": "Klassisk",
  "editor.svg_theme.classic_dark": "Klassisk M\xF6rkt",
  "editor.icon_set": "Ikonstil",
  "editor.icon_set.modern": "Modern (standard)",
  "editor.icon_set.isometric": "Isometrisk",
  "edge_tooltip.band_24": "2.4GHz",
  ...
  "edge_tooltip.speed_gbps": "{speed} Gbps",
  "edge_tooltip.speed_mbps": "{speed} Mbps",
  "edge_tooltip.wired": "Tr\xE5dbunden",
  "edge_tooltip.wireless": "Tr\xE5dl\xF6s",
  "entity_modal.device_info": "Enhetsinformation",
  "entity_modal.device_type": "Enhetstyp",
  "entity_modal.ip": "IP-adress",
  "entity_modal.last_changed": "Senast \xE4ndrad",
  "entity_modal.mac": "MAC-adress",
  "entity_modal.model": "Modell",
  "entity_modal.no_entities": "Inga Home Assistant-entiteter hittades f\xF6r denna enhet",
  "entity_modal.related_entities": "Relaterade entiteter",
  "entity_modal.related_entities_count": "Relaterade entiteter ({count})",
  "entity_modal.status": "Status",
  "entity_modal.status_offline": "Offline",
  "entity_modal.status_online": "Online",
  "entity_modal.status_unknown": "Ok\xE4nd",
  "panel.actions.copy_ip": "Kopiera IP-adress",
  "panel.actions.copy_mac": "Kopiera MAC-adress",
  "panel.actions.entity": "Entitet",
  "panel.actions.no_entity": "Ingen Home Assistant-entitet l\xE4nkad",
  "panel.actions.title": "Snabb\xE5tg\xE4rder",
  "panel.actions.view_entity": "Visa entitetsdetaljer",
  "panel.actions.view_ports": "Visa port\xF6versikt",
  "panel.badge.poe": "PoE",
  "panel.badge.wifi": "WiFi",
  "panel.connected_devices": "Anslutna enheter",
  "panel.device_breakdown": "Enhetsf\xF6rdelning",
  "panel.device_info": "Enhetsinformation",
  "panel.device_type.access_points": "Accesspunkter",
  "panel.device_type.clients": "Klienter",
  "panel.device_type.gateways": "Gateways",
  "panel.device_type.other": "\xD6vriga",
  "panel.device_type.switches": "Switchar",
  "panel.entities": "Home Assistant-entiteter",
  "panel.hint": "Klicka p\xE5 en nod i kartan f\xF6r att se detaljer",
  "panel.loading": "Laddar n\xE4tverksdata...",
  "panel.network": "N\xE4tverk",
  "panel.network_info": "N\xE4tverksinformation",
  "panel.no_connections": "Inga anslutningar",
  "panel.no_data": "Ingen data tillg\xE4nglig",
  "panel.overview": "N\xE4tverks\xF6versikt",
  ...
  "panel.stats.wired": "Tr\xE5dbunden",
  "panel.stats.wireless": "Tr\xE5dl\xF6s",
  "panel.stats.wireless_clients": "Tr\xE5dl\xF6sa klienter",
  "panel.status.last_changed": "Senast \xE4ndrad",
  "panel.status.live": "Livestatus",
  "panel.status.offline": "Offline",
  "panel.status.online": "Online",
  "panel.status.status": "Status",
  "panel.status.unknown": "Ok\xE4nd",
  "panel.tabs.actions": "\xC5tg\xE4rder",
  "panel.tabs.overview": "\xD6versikt",
  "panel.tabs.stats": "Statistik",
  "panel.vlan": "VLAN",
  "panel.vlan_id": "VLAN-ID",
  ...
  "port_modal.port": "Port {port}",
  "port_modal.title": "Port\xF6versikt",
  "toast.copied": "Kopierat!",
  "toast.copy_ip": "IP-adress kopierad!",
  "toast.copy_mac": "MAC-adress kopierad!",
  "toast.no_entity": "Ingen entitet hittades f\xF6r denna enhet",
