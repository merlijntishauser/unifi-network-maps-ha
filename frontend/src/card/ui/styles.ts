/**
 * Styles for overlays (entity modal, context menu) appended to document.body.
 * They render outside the card DOM, so these rules only take effect via
 * GLOBAL_STYLES; the card stylesheet does not need a copy.
 */
