export const fr = {
  ...
  "card.preview.alt": "Aperçu de UniFi Network Map",
  ...
  "editor.theme.unifi": "UniFi (par défaut)",
  "editor.theme.unifi_dark": "UniFi sombre",
  "editor.svg_theme": "Couleurs de la carte",
  "editor.svg_theme.unifi": "UniFi (par défaut)",
  ...
  "editor.icon_set": "Style d'icônes",
  "editor.icon_set.modern": "Moderne (par défaut)",
  "editor.icon_set.isometric": "Isométrique",
  ...
  "panel.vpn.remote_subnets": "Sous-réseaux distants",
